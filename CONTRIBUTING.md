...
All tests are deterministic and make no LLM calls. That's a hard invariant,
not a current state. A PR that adds a test needing an API key or network
access will be asked to mock it.
